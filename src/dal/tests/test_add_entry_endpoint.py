...
class TestAddEntryEndpoint(unittest.TestCase):
    ...
    def setUp(self, mock_parse_args):
        mock_parse_args.return_value = MockArgs(mongo_uri="some-mongodb-uri", enable_api=False, port=0)
        app = create_app()
        app.testing = True
    ...
    def test_missing_date(self):
        invalid_data = {"mode": "pos", "tagged_sentence": [["tag11", "word1"], ["tag2", "word2"]]}
    ...
    def test_missing_tagged_sentence(self):
        invalid_data = {"date": "2023-10-24T14:30:00+00:00", "mode": "pos"}

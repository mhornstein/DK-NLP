...
class TestTagger(unittest.TestCase):
    ...
    def test_tag_pos(self):
        ...
        expected_tags = [['This', 'DT'], ['is', 'VBZ'], ['a', 'DT'], ['test', 'NN'], ['sentence', 'NN'], ['.', '.']]
    ...
    def test_tag_ner(self):
        ...
        expected_tags = [['Google', 'ORG'], ['is', 'O'], ['an', 'O'], ['organization', 'O'], ['based', 'O'], ['in', 'O'], ['San', 'LOC'], ['Francisco', 'LOC'], [',', 'O'], ['California', 'LOC'], ['.', 'O']]
        self.assertIsInstance(tags, list)
        self.assertEqual(tags, expected_tags)
